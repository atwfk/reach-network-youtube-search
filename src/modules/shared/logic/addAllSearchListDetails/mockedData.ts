...
export const channelsDetails: IGetMoreSearchDetails.IChannelResApi = {
...
export const playlistDetails: IGetMoreSearchDetails.IPlayListResApi = {
...
export const searchListDetails: Map<
  string,
...
searchListDetails.set("31ieHmcTUOk", {
  kind: "youtube#video",
  etag: "msuimHP7LRNROTpHpnf5cIf0o54",
  id: "31ieHmcTUOk",
  contentDetails: {
...
searchListDetails.set("UCW5YeuERMmlnqo4oq8vwUpg", {
  kind: "youtube#channel",
  etag: "kaUmGaqakxiMrsi5xZ0EzckBdjE",
  id: "UCW5YeuERMmlnqo4oq8vwUpg",
  statistics: {
...
searchListDetails.set("PL4cUxeGkcC9hxjeEtdHFNYMtCpjNBm3h7", {
  kind: "youtube#playlist",
  etag: "weNBrdoqrxkB99DJCnYttpXH6UQ",
  id: "PL4cUxeGkcC9hxjeEtdHFNYMtCpjNBm3h7",
  contentDetails: {
...
export const searchSnippets: IGetSearchRes.IResApi = {
